...
public class GPA_Calculator {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    if (!gradeText.isEmpty() && !unitText.isEmpty()) {
                        ...
                        totalGradePoints = grade(grade, units, totalGradePoints);
    ...
    public static double grade(double grade, double units, double totalGradePoints) {
    	return totalGradePoints + (grade * units);
    }
